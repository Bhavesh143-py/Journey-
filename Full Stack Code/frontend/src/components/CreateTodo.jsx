...
export function CreateTodo({ addTodo, token }) {
    ...
    return (
        <div className="w-2/3 mx-auto  shadow-sm m-4">
            <div className="flex justify-center items-center mx-auto py-4 ">
                ...
                <form className="">
                    ...
                    <input
                        className=" p-2.5 w-full flex justify-center text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                        type="text"
                        placeholder="Title"
                        value={title}
                ...
                <form className="max-w-[8rem] mx-auto">
                    ...
                    <div className="relative">
                        ...
                        <input type="time" id="time" value={tasktimings} onChange={(e) => setTasktimings(e.target.value)} className="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " min="09:00" max="18:00" required />
                    </div>
                </form>
                </div>
            </div>
